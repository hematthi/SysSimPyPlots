...
plot_fig_pdf_simple([sss['Rm_obs'][sss['Rm_obs'] < R_max_cut] for sss in split_sss], [ssk['Rm_obs'][ssk['Rm_obs'] < R_max_cut] for ssk in split_ssk], x_min=1., x_max=R_max_cut, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, log_x=True, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xticks_custom=[1,2,3,4,5,10,20], xlabel_text=r'$\mathcal{P} = P_{i+1}/P_i$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_periodratios_compare.pdf', save_fig=savefigures)

# Transit durations:
plot_fig_pdf_simple([sss['tdur_obs'] for sss in split_sss], [ssk['tdur_obs'] for ssk in split_ssk], x_min=0., x_max=15., n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$t_{\rm dur}$ (hrs)', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_durations_compare.pdf', save_fig=savefigures)

# Circular normalized transit durations:
plot_fig_pdf_simple([sss['tdur_tcirc_obs'] for sss in split_sss], [ssk['tdur_tcirc_obs'] for ssk in split_ssk], x_min=0., x_max=1.5, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$t_{\rm dur}/t_{\rm circ}$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_tdur_tcirc_compare.pdf', save_fig=savefigures)

# Circular normalized transit durations (separate singles and multis):
plot_fig_pdf_simple([sss['tdur_tcirc_1_obs'] for sss in split_sss], [ssk['tdur_tcirc_1_obs'] for ssk in split_ssk], x_min=0., x_max=1.5, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], extra_text='Observed singles', xlabel_text=r'$t_{\rm dur}/t_{\rm circ}$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_tdur_tcirc_singles_compare.pdf', save_fig=savefigures)
plot_fig_pdf_simple([sss['tdur_tcirc_2p_obs'] for sss in split_sss], [ssk['tdur_tcirc_2p_obs'] for ssk in split_ssk], x_min=0., x_max=1.5, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], extra_text='Observed multis', xlabel_text=r'$t_{\rm dur}/t_{\rm circ}$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_tdur_tcirc_multis_compare.pdf', save_fig=savefigures)

# Log(xi):
plot_fig_pdf_simple([np.log10(sss['xi_obs']) for sss in split_sss], [np.log10(ssk['xi_obs']) for ssk in split_ssk], x_min=-0.5, x_max=0.5, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\log{\xi}$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_logxi_all_compare.pdf', save_fig=savefigures)

# Transit depths:
plot_fig_pdf_simple([sss['D_obs'] for sss in split_sss], [ssk['D_obs'] for ssk in split_ssk], x_min=1e-5, x_max=10.**-1.5, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, log_x=True, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\delta$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_depths_compare.pdf', save_fig=savefigures)

# Transit depth ratios:
plot_fig_pdf_simple([sss['D_ratio_obs'] for sss in split_sss], [ssk['D_ratio_obs'] for ssk in split_ssk], x_min=10.**-1.5, x_max=10.**1.5, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, log_x=True, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\delta_{i+1}/\delta_i$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_depthratios_compare.pdf', save_fig=savefigures)

# Planet radii:
plot_fig_pdf_simple([sss['radii_obs'] for sss in split_sss], [ssk['radii_obs'] for ssk in split_ssk], x_min=radii_min, x_max=radii_max, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$R_p (R_\oplus)$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_radii_compare.pdf', save_fig=savefigures)

# Stellar radii:
plot_fig_pdf_simple([sss_per_sys['Rstar_obs'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['Rstar_obs'] for ssk_per_sys in split_ssk_per_sys], n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$R_\star (R_\odot)$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_stellar_radii_compare.pdf', save_fig=savefigures)

# Stellar masses:
plot_fig_pdf_simple([sss_per_sys['Mstar_obs'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['Mstar_obs'] for ssk_per_sys in split_ssk_per_sys], x_max=2., n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$M_\star (M_\odot)$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_stellar_masses_compare.pdf', save_fig=savefigures)

# Stellar teff:
plot_fig_pdf_simple([sss_per_sys['teff_obs'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['teff_obs'] for ssk_per_sys in split_ssk_per_sys], n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$t_{\rm eff} (K)$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_stellar_teff_compare.pdf', save_fig=savefigures)

# Stellar colors:
plot_fig_pdf_simple([sss_per_sys['bp_rp_obs'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['bp_rp_obs'] for ssk_per_sys in split_ssk_per_sys], n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$b_p - r_p$ (mag)', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_stellar_bprp_compare.pdf', save_fig=savefigures)

### GF2020 metrics:
# Planet radii partitioning:
plot_fig_pdf_simple([sss_per_sys['radii_partitioning'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['radii_partitioning'] for ssk_per_sys in split_ssk_per_sys], x_min=1e-5, x_max=1., n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, log_x=True, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\mathcal{Q}_R$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_radii_partitioning_compare.pdf', save_fig=savefigures)

# Planet radii monotonicity:
plot_fig_pdf_simple([sss_per_sys['radii_monotonicity'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['radii_monotonicity'] for ssk_per_sys in split_ssk_per_sys], x_min=-0.5, x_max=0.6, n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\mathcal{M}_R$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_radii_monotonicity_compare.pdf', save_fig=savefigures)

# Gap complexity:
plot_fig_pdf_simple([sss_per_sys['gap_complexity'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['gap_complexity'] for ssk_per_sys in split_ssk_per_sys], x_min=0., x_max=1., n_bins=n_bins, normalize=False, N_sim_Kep_factor=float(N_sim)/N_Kep, log_x=False, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\mathcal{C}$', ylabel_text='Number', afs=afs, tfs=tfs, lfs=lfs, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_gap_complexity_compare.pdf', save_fig=savefigures)
...
plot_fig_cdf_simple([sss['tdur_obs'] for sss in split_sss], [ssk['tdur_obs'] for ssk in split_ssk], x_min=0., x_max=15., c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$t_{\rm dur}$ (hrs)', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_durations_CDFs.pdf', save_fig=savefigures)

# Circular normalized transit durations:
plot_fig_cdf_simple([sss['tdur_tcirc_obs'] for sss in split_sss], [ssk['tdur_tcirc_obs'] for ssk in split_ssk], x_min=0., x_max=1.5, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$t_{\rm dur}/t_{\rm circ}$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_tdur_tcirc_CDFs.pdf', save_fig=savefigures)

# Circular normalized transit durations (separate singles and multis):
plot_fig_cdf_simple([sss['tdur_tcirc_1_obs'] for sss in split_sss], [ssk['tdur_tcirc_1_obs'] for ssk in split_ssk], x_min=0., x_max=1.5, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], extra_text='Observed singles', xlabel_text=r'$t_{\rm dur}/t_{\rm circ}$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_tdur_tcirc_singles_CDFs.pdf', save_fig=savefigures)
plot_fig_cdf_simple([sss['tdur_tcirc_2p_obs'] for sss in split_sss], [ssk['tdur_tcirc_2p_obs'] for ssk in split_ssk], x_min=0., x_max=1.5, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], extra_text='Observed multis', xlabel_text=r'$t_{\rm dur}/t_{\rm circ}$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_tdur_tcirc_multis_CDFs.pdf', save_fig=savefigures)

# Transit depths CDFs:
plot_fig_cdf_simple([sss['D_obs'] for sss in split_sss], [ssk['D_obs'] for ssk in split_ssk], log_x=True, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\delta$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_depths_CDFs.pdf', save_fig=savefigures)

# Planet radii CDFs:
plot_fig_cdf_simple([sss['radii_obs'] for sss in split_sss], [ssk['radii_obs'] for ssk in split_ssk], x_min=radii_min, x_max=radii_max, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$R_p (R_\oplus)$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_radii_CDFs.pdf', save_fig=savefigures)

# Transit depth ratios CDFs:
plot_fig_cdf_simple([sss['D_ratio_obs'] for sss in split_sss], [ssk['D_ratio_obs'] for ssk in split_ssk], x_min=10.**-1.5, x_max=10.**1.5, log_x=True, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\delta_{i+1}/\delta_i$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_depthratios_CDFs.pdf', save_fig=savefigures)

# Log(xi) CDFs:
plot_fig_cdf_simple([np.log10(sss['xi_obs']) for sss in split_sss], [np.log10(ssk['xi_obs']) for ssk in split_ssk], x_min=-0.5, x_max=0.5, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\log{\xi}$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_logxi_all_CDFs.pdf', save_fig=savefigures)

### GF2020 metrics:
# Planet radii partitioning CDFs:
plot_fig_cdf_simple([sss_per_sys['radii_partitioning'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['radii_partitioning'] for ssk_per_sys in split_ssk_per_sys], x_min=1e-5, x_max=1., log_x=True, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\mathcal{Q}_R$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_radii_partitioning_CDFs.pdf', save_fig=savefigures)

# Planet radii monotonicity CDFs:
plot_fig_cdf_simple([sss_per_sys['radii_monotonicity'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['radii_monotonicity'] for ssk_per_sys in split_ssk_per_sys], x_min=-0.5, x_max=0.6, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\mathcal{M}_R$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_radii_monotonicity_CDFs.pdf', save_fig=savefigures)

# Gap complexity CDFs:
plot_fig_cdf_simple([sss_per_sys['gap_complexity'] for sss_per_sys in split_sss_per_sys], [ssk_per_sys['gap_complexity'] for ssk_per_sys in split_ssk_per_sys], x_min=0., x_max=1., log_x=False, c_sim=split_colors, c_Kep=split_colors, ls_sim=split_linestyles, ls_Kep=split_linestyles_Kep, lw=lw, labels_sim=split_names, labels_Kep=[None, None], xlabel_text=r'$\mathcal{C}$', afs=afs, tfs=tfs, lfs=lfs, label_dist=True, fig_size=fig_size, fig_lbrt=fig_lbrt, save_name=savefigures_directory + subdirectory + model_name + '_gap_complexity_CDFs.pdf', save_fig=savefigures)
