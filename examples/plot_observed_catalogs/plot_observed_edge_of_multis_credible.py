...
plot_fig_cdf_simple([], [Pratio_out_per_sys_Kep[ssk_per_sys['Mtot_obs'] == 2]], x_min=1., x_max=80., log_x=True, lw=lw, labels_Kep=['Kepler'], xticks_custom=[1,2,3,5,10,20,40], xlabel_text=r'$P_{\rm out}/P_{\rm 2nd\ out}$', afs=afs, tfs=tfs, lfs=lfs, legend=True, fig_size=fig_size, fig_lbrt=fig_lbrt)
...
plot_fig_cdf_simple([], [Pratio_out_per_sys_Kep[ssk_per_sys['Mtot_obs'] == 3]], x_min=1., x_max=80., log_x=True, lw=lw, labels_Kep=['Kepler'], xticks_custom=[1,2,3,5,10,20,40], xlabel_text=r'$P_{\rm out}/P_{\rm 2nd\ out}$', afs=afs, tfs=tfs, lfs=lfs, legend=True, fig_size=fig_size, fig_lbrt=fig_lbrt)
...
plot_fig_cdf_simple([], [Pratio_out_per_sys_Kep[ssk_per_sys['Mtot_obs'] >= 4]], x_min=1., x_max=80., log_x=True, lw=lw, labels_Kep=['Kepler'], xticks_custom=[1,2,3,5,10,20,40], xlabel_text=r'$P_{\rm out}/P_{\rm 2nd\ out}$', afs=afs, tfs=tfs, lfs=lfs, legend=True, fig_size=fig_size, fig_lbrt=fig_lbrt)
