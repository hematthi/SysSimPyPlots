...
# Corner plot with scatter points colored by depth:
fig = plot_points_corner(active_params_symbols, active_params_all, fpoints=radii_measures['delta_depth_kde'], f_label=r'$\Delta_{\rm valley}$', cmap='Reds', points_size=2., tfs=13, save_name=savefigures_directory + model_name + '_params_delta_depths_corner.pdf')
...
if savefigures:
    plt.savefig(savefigures_directory + model_name + '_params_delta_depths_corner.pdf')
    plt.close()
plt.show()
