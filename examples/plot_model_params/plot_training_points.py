...
run_directory = 'Hybrid_NR20_AMD_model1/clustered_initial_masses/Fit_all12_KS/Params10_fix_highM/GP_files/'
...
data_optim = load_training_points(dims, file_name_path=loadfiles_directory, file_name='Active_params_distances_table_best10000_every1.txt')
...
if transformed_rates:
    plot_cornerpy_wrapper(active_params_transformed_symbols, transform_sum_diff_params(data_train['xtrain'], i_transformed, j_transformed), xpoints_extra=transform_sum_diff_params(xmins, i_transformed, j_transformed), save_name=savefigures_directory + model_name + '_training_transformed_corner.pdf', save_fig=savefigures)
plt.close()
'''
