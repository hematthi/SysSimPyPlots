...
def measure_and_plot_radius_valley_depth_using_kde(radii_sample, radius_valley_bounds=(1.8,2.2), x_min=0.5, x_max=5.5, n_bins=100, bw='Scotts', bw_scotts_factor=1., fractional_depth=True, xlabel_text=r'Planet radius, $R_p$ [$R_\oplus$]', verbose=False, plot_fig=False, ax=None, legend=True, save_name='no_name_fig.pdf', save_fig=False):
    ...
    Same as :py:func:`measure_and_plot_radius_valley_depth_using_global_bins` except the bins are replaced by a KDE.
    ...
    kde = scipy.stats.gaussian_kde(radii_sample, bw_method=bw)
...
def measure_and_plot_radius_valley_depth_using_two_kdes(radii_sample, radius_valley_bounds=(1.8,2.2), x_min=0.5, x_max=5.5, n_bins=100, bw_low='Scotts', bw_high='Scotts', bw_low_scotts_factor=0.25, bw_high_scotts_factor=2., fractional_depth=True, xlabel_text=r'Planet radius, $R_p$ [$R_\oplus$]', verbose=False, plot_fig=False, save_name='no_name_fig.pdf', save_fig=False):
    ...
    Note
    ----
    This method of measuring the depth does not work as well as using a single KDE; instead, the use of :py:func:`syssimpyplots.plot_catalogs.measure_and_plot_radius_valley_depth_using_kde` is recommended.
    """
    # Fit the KDEs:
    ...
    kde_low = scipy.stats.gaussian_kde(radii_sample, bw_method=bw_low)
    kde_high = scipy.stats.gaussian_kde(radii_sample, bw_method=bw_high)
